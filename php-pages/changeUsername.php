...
require('../php/userChangeValidator.php');
...
if (isset($_POST['submitButton'])) {
    $userChangeValidation = new userChangeValidator($_POST);
    $errors = $userChangeValidation->validateForm();
    if (empty($errors)) {
        $userChanged = true;
    }
}
    ...
    <div class="row justify-content-center" id="registerContainer">
        <div class="col-md-4 col-11">
            <div class="rounded text-white p-5" id="registerMenu">
                <p class="h4 fw-bold">Change username below:</p>
                <hr>
                <div class="lead text-success" id="successMessage">
                    <?php echo htmlspecialchars(!empty($userChanged) ? 'Username change successful! Redirecting...' : '')?>
                </div>
                <form action="" method="post">
                    <div class="form-group pt-3">
                        <label for="passwordInput" class="">Please enter your password:</label>
                    ...
                    <div class="form-group pt-5">
                        <label for="newUsernameInput">Please enter your desired username:</label>
                        <input type="text" class="form-control" id="newUsernameInput" placeholder="Enter new username:" name="username">
                    </div>
                    <div class="lead text-danger">
