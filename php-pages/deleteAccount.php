    ...
    <div class="row justify-content-center" id="registerContainer">
        <div class="col-md-4 col-11">
            <div class="rounded text-white p-5" id="registerMenu">
                <p class="h4 fw-bold">Delete account</p>
                <hr>
                <div class="lead text-success" id="successMessage">
                    <?php echo htmlspecialchars(!empty($deletedAccount) ? 'Account deletion successful. Redirecting...' : '')?>
                </div>
                <form action="" method="post">
                    <p class="text-center">You are about to delete your account. Proceed?</p>
                    <button type="submit" id="loginSubmit" class="btn btn-danger border-light-subtle mt-1" name="submitButton">Delete account.</button>
                </form>
            </div>
        </div>
    </div>
